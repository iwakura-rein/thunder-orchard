...
echo "Building thunder_orchard_app..."
cargo build --manifest-path "$REPO_ROOT/Cargo.toml" --bin thunder_orchard_app
...
THUNDER_ORCHARD_APP='$REPO_ROOT/target/debug/thunder_orchard_app'
EOF
